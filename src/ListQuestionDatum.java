...
public class ListQuestionDatum {
    ...
    public ListQuestionDatum(String id, String content, String dapAnA, String dapAnB, String dapAnC, String dapAnD,
                             String dapAnE, String dapAnF, String direction, String position, String dapAnDung, String rate,
                             String thuocChuong, String isFavourite) {
        super();
        this.id = id;
    ...
    public String toString() {
        return "ListQuestionDatum [id=" + id + ", content=" + content + ", dapAnA=" + dapAnA + ", dapAnB=" + dapAnB
                ...
                + ", thuocChuong=" + thuocChuong + ", isFavourite=" + isFavourite + "]";
    }
